const Partners = () => {
  ...
  return (
    <section id="partners" style={{ paddingTop: '80px', paddingBottom: '80px', backgroundColor: '#fff' }}>
          ...
          {partners.map((partner, index) => (
            ...
            >
              <div style={{ textAlign: 'center' }}>
                ...
                />
                <p style={{ margin: 0, fontSize: '13px', fontWeight: '600', color: '#003d82', lineHeight: '1.4' }}>
                  {partner.name}
                </p>
              </div>
            </div>
