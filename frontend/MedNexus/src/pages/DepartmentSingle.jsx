...
const departmentsData = {
  1: {
    title: "Ophthalmology",
    description:
      "Our ophthalmology department provides comprehensive eye care services with state-of-the-art technology and experienced specialists.",
  ...
  2: {
    title: "Cardiology",
    description:
      "Our cardiology department offers expert care for all heart-related conditions with cutting-edge diagnostic and treatment facilities.",
  ...
  3: {
    title: "Dental Care",
    description:
      "Our dental department provides complete oral health services from preventive care to advanced cosmetic and restorative procedures.",
  ...
  4: {
    title: "Child Care",
    description:
      "Our pediatric department specializes in providing compassionate healthcare for children from infancy through adolescence.",
  ...
  5: {
    title: "Pulmonology",
    description:
      "Our pulmonology department specializes in diagnosing and treating respiratory conditions with advanced technology.",
  ...
  6: {
    title: "Gynecology",
    description:
      "Our gynecology department provides comprehensive women's health services with a focus on personalized care.",
      ...
      <section className="department-single-hero">
        ...
        <div className="container mx-auto px-4">
          <div className="department-single-hero-content">
            <span className="department-single-hero-subtitle">
              Department Details
            </span>
          ...
          <div className="department-single-layout">
            ...
            <div className="department-main-content">
              ...
              <div className="department-description">
                <h2 className="department-description-title">
                ...
                <div className="department-services-grid">
                  {department.services.map((service, index) => (
                    <div key={index} className="department-service-item">
                      <CheckCircle
                        className="department-service-icon"
                        size={24}
                      />
              ...
              <div className="department-cta">
                <h3 className="department-cta-title">
                ...
                <button
                  ...
                  className="department-cta-button"
                >
                  Make an Appointment
                </button>
              </div>
