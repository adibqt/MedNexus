...
const departmentsData = [
  {
    ...
    title: "Ophthalmology",
    description:
      "Comprehensive eye care services including vision correction, cataract surgery, and treatment of eye diseases.",
  ...
  },
  {
    ...
    title: "Cardiology",
    description:
      "Expert cardiac care for heart conditions, including diagnosis, treatment, and preventive care.",
  ...
  },
  {
    ...
    title: "Dental Care",
    description:
      "Complete dental services from routine check-ups to advanced dental procedures and cosmetic dentistry.",
  ...
  },
  {
    ...
    title: "Child Care",
    description:
      "Pediatric services focused on the health and wellbeing of infants, children, and adolescents.",
  ...
  },
  {
    ...
    title: "Pulmonology",
    description:
      "Specialized care for respiratory conditions including asthma, COPD, and lung diseases.",
  ...
  },
  {
    ...
    title: "Gynecology",
    description:
      "Women's health services including reproductive health, prenatal care, and gynecological procedures.",
      ...
      <section className="departments-section">
        <div className="container mx-auto px-4">
          ...
          <div className="departments-header">
            <h2 className="departments-main-title">
              Award Winning Patient Care
            </h2>
            <div className="departments-divider" />
            <p className="departments-subtitle">
              Explore MedNexus specialties for fast bookings, video consults,
              and coordinated follow-ups across primary care, cardiology,
